...
pdo = { hex2dec('1601'),...
           hex2dec({'1602','1603'}), ...
           [ hex2dec('7000'), 1, 8, 1008;
             0              , 0, 8, 0   ;
             hex2dec('7000'), 2,16, 1016],...
           { 0, 2 };
        hex2dec('1602'),...
           hex2dec({'1601','1603'}), ...
        ...
        hex2dec('1603'),...
           ...
           [ hex2dec('7010'), 1, 1, 1001;
             ...
             0              , 0, 4, 0   ;
             0              , 0, 8, 0   ;
             hex2dec('7010'),17,32, 1032],...
           { 0:3, 6 };
        hex2dec('1a01'),...
           hex2dec({'1a03','1a04','1a05','1a06','1a07','1a08'}),...
           [ hex2dec('6000'), 1, 8, 1008;
             0              , 0, 8, 0   ;
             hex2dec('6000'), 2,16, 1016;
             hex2dec('6000'), 3,16, 1016],...
           { 0, 2, 3 };
        hex2dec('1a02'),...
           hex2dec({'1a03','1a04','1a05','1a06','1a07','1a08'}),...
           [ hex2dec('6000'), 4,32, 1032;
             hex2dec('6000'), 5,16, 1016;
             hex2dec('6000'), 6,16, 1016],...
           { 0, 1, 2 };
        hex2dec('1a03'),...
           ...
           [ hex2dec('6010'), 1, 1, 1001;
             ...
             hex2dec('6010'), 9, 1, 1001;
             hex2dec('6010'),10, 1, 1001;
             hex2dec('6010'),11, 1, 1001;
             hex2dec('6010'),12, 1, 1001;
             hex2dec('6010'),13, 1, 1001;
             hex2dec('1c32'),32, 1, 1001;
             hex2dec('1803'), 7, 1, 1001;
             hex2dec('1803'), 9, 1, 1001;
             hex2dec('6010'),17,16, 1016;
             hex2dec('6010'),18,16, 1016],...
           { 0:12, 16, 17 };
        hex2dec('1a04'),...
           ...
           [ hex2dec('6010'), 1, 1, 1001;
             ...
             hex2dec('6010'),13, 1, 1001;
             hex2dec('1c32'),32, 1, 1001;
             hex2dec('1804'), 7, 1, 1001;
             hex2dec('1804'), 9, 1, 1001;
             hex2dec('6010'),17,32, 1032;
             hex2dec('6010'),18,32, 1032],...
           { 0:12, 16, 17 };
        hex2dec('1a05'),...
           hex2dec({'1a01','1a02','1a06'}),...
           [ hex2dec('6010'),19,32, 1032],...
           { 0 };
        hex2dec('1a06'),...
           hex2dec({'1a01','1a02','1a05'}),...
           [ hex2dec('6010'),20,32, 1032],...
           { 0 };
        hex2dec('1a07'),...
           hex2dec({'1a01','1a02','1a08'}),...
           [ hex2dec('6010'),22,64, 1032],...
           { 0 };
        hex2dec('1a08'),...
           hex2dec({'1a01','1a02','1a07'}),...
           [hex2dec('6010'),22,32, 1032],...
           { 0 };
};
