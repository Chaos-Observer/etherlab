...
pdo = [...
        hex2dec('1a00'),  hex2dec('6000'),  1, 1001; ...
        hex2dec('1a01'),  hex2dec('6010'),  1, 1001; ...
        hex2dec('1a02'),  hex2dec('6020'),  1, 1001; ...
        hex2dec('1a03'),  hex2dec('6030'),  1, 1001; ...
        hex2dec('1a04'),  hex2dec('6040'),  1, 1001; ...
        hex2dec('1a05'),  hex2dec('6050'),  1, 1001; ...
        hex2dec('1a06'),  hex2dec('6060'),  1, 1001; ...
        hex2dec('1a07'),  hex2dec('6070'),  1, 1001; ...
        hex2dec('1a08'),  hex2dec('6080'),  1, 1001; ...
        hex2dec('1a09'),  hex2dec('6090'),  1, 1001; ...
        hex2dec('1a0a'),  hex2dec('60a0'),  1, 1001; ...
        hex2dec('1a0b'),  hex2dec('60b0'),  1, 1001; ...
        hex2dec('1a0c'),  hex2dec('60c0'),  1, 1001; ...
        hex2dec('1a0d'),  hex2dec('60d0'),  1, 1001; ...
        hex2dec('1a0e'),  hex2dec('60e0'),  1, 1001; ...
        hex2dec('1a0f'),  hex2dec('60f0'),  1, 1001; ...
        hex2dec('1a00'),  hex2dec('f600'), 16, 1016; ...
        ];
...
rv.sm{1}{3} = arrayfun(...
        @(x) {pdo(x,1), [pdo(x,2),1,pdo(x,3),pdo(x,4)]}, rows,...
        'UniformOutput', false);
return
...
if strcmp(get_param(gcbh,'vector'), 'on')
    ...
    rv.output = arrayfun(@(x) struct('pdo', [0, x, 0, 0]), r);
end
