...
sm = {...
           {{hex2dec('1600'), [ hex2dec('7000'), 1, 1, 1001]},... %1
            {hex2dec('1601'), [ hex2dec('7010'), 1, 1, 1001]},...
            {hex2dec('1602'), [ hex2dec('7020'), 1, 1, 1001]},...
            {hex2dec('1603'), [ hex2dec('7030'), 1, 1, 1001]},...
            {hex2dec('1604'), [ hex2dec('7040'), 1, 1, 1001]},...
            {hex2dec('1605'), [ hex2dec('7050'), 1, 1, 1001]},...
            {hex2dec('1606'), [ hex2dec('7060'), 1, 1, 1001]},...
            {hex2dec('1607'), [ hex2dec('7070'), 1, 1, 1001]}},...
           {{hex2dec('1608'), [ hex2dec('7080'), 1, 1, 1001]},... %2
            {hex2dec('1609'), [ hex2dec('7090'), 1, 1, 1001]},...
            {hex2dec('160a'), [ hex2dec('70a0'), 1, 1, 1001]},...
            {hex2dec('160b'), [ hex2dec('70b0'), 1, 1, 1001]},...
            {hex2dec('160c'), [ hex2dec('70c0'), 1, 1, 1001]},...
            {hex2dec('160d'), [ hex2dec('70d0'), 1, 1, 1001]},...
            {hex2dec('160e'), [ hex2dec('70e0'), 1, 1, 1001]},...
            {hex2dec('160f'), [ hex2dec('70f0'), 1, 1, 1001]}},...
           {{hex2dec('1a00'), [ hex2dec('6000'), 1, 1, 1001]},... %3
            {hex2dec('1a01'), [ hex2dec('6010'), 1, 1, 1001]},...
            {hex2dec('1a02'), [ hex2dec('6020'), 1, 1, 1001]},...
            {hex2dec('1a03'), [ hex2dec('6030'), 1, 1, 1001]},...
            {hex2dec('1a04'), [ hex2dec('6040'), 1, 1, 1001]},...
            {hex2dec('1a05'), [ hex2dec('6050'), 1, 1, 1001]},...
            {hex2dec('1a06'), [ hex2dec('6060'), 1, 1, 1001]},...
            {hex2dec('1a07'), [ hex2dec('6070'), 1, 1, 1001]}},...
           {{hex2dec('1a08'), [ hex2dec('6080'), 1, 1, 1001]},... %4
            {hex2dec('1a09'), [ hex2dec('6090'), 1, 1, 1001]},...
            {hex2dec('1a0a'), [ hex2dec('60a0'), 1, 1, 1001]},...
            {hex2dec('1a0b'), [ hex2dec('60b0'), 1, 1, 1001]},...
            {hex2dec('1a0c'), [ hex2dec('60c0'), 1, 1, 1001]},...
            {hex2dec('1a0d'), [ hex2dec('60d0'), 1, 1, 1001]},...
            {hex2dec('1a0e'), [ hex2dec('60e0'), 1, 1, 1001]},...
            {hex2dec('1a0f'), [ hex2dec('60f0'), 1, 1, 1001]}},...
           {{hex2dec('1604'), [               0, 0, 4,    0;...  %5
                                hex2dec('7040'), 1, 1, 1001]},...
            {hex2dec('1605'), [ hex2dec('7050'), 1, 1, 1001]},...
            {hex2dec('1606'), [ hex2dec('7060'), 1, 1, 1001]},...
            {hex2dec('1607'), [ hex2dec('7070'), 1, 1, 1001]}},...
           {{hex2dec('1a00'), [ hex2dec('6000'), 1, 1, 1001]},... %6
            {hex2dec('1a01'), [ hex2dec('6010'), 1, 1, 1001]},...
            {hex2dec('1a02'), [ hex2dec('6020'), 1, 1, 1001]},...
            {hex2dec('1a03'), [ hex2dec('6030'), 1, 1, 1001;...
                                              0, 0, 4,    0]}},...
           {{hex2dec('1600'), [ hex2dec('7000'), 1, 1, 1001;... %7
                                hex2dec('7010'), 1, 1, 1001;...
                                hex2dec('7020'), 1, 1, 1001;...
                                hex2dec('7030'), 1, 1, 1001]},...
            {hex2dec('1601'), [ hex2dec('7040'), 1, 1, 1001;...
                                hex2dec('7050'), 1, 1, 1001;...
                                hex2dec('7060'), 1, 1, 1001;...
                                hex2dec('7070'), 1, 1, 1001]}},...
           {{hex2dec('1600'), [ hex2dec('7000'), 1, 1, 1001]},... %8
            {hex2dec('1601'), [ hex2dec('7010'), 1, 1, 1001]},...
            {hex2dec('1602'), [ hex2dec('7020'), 1, 1, 1001]},...
            {hex2dec('1603'), [ hex2dec('7030'), 1, 1, 1001]}} ...
};
...
if strcmp(get_param(gcbh,'vector'),'on')
    ...
    port = arrayfun(@(x) struct('pdo', sub_index(x,:)), 1:size(sub_index,1));
end
