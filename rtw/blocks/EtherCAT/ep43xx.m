...
output_sm       = {2, 0, { {hex2dec('1600') [hex2dec('7020'),17,16, 2016]},...
                           {hex2dec('1601') [hex2dec('7030'),17,16, 2016]}}};

input_sm        = {3, 1, { {hex2dec('1a01') [hex2dec('6000'),17,16, 2016]},...
                           {hex2dec('1a03') [hex2dec('6010'),17,16, 2016]}}};

status_input_sm = {3, 1, { {hex2dec('1a00') [hex2dec('6000'), 1, 1, 1001;...
                                             hex2dec('6000'), 2, 1, 1001;...
                                             hex2dec('6000'), 3, 2, 1002;...
                                             hex2dec('6000'), 5, 2, 1002;...
                                             hex2dec('6000'), 7, 1, 1001;...
                                             0              , 0, 1, 0   ;...
                                             0              , 0, 5, 0   ;...
                                             hex2dec('6000'),14, 1, 1001;...
                                             hex2dec('6000'),15, 1, 1001;...
                                             hex2dec('6000'),16, 1, 1001;...
                                             hex2dec('6000'),17,16, 2016]},...
                           {hex2dec('1a02') [hex2dec('6010'), 1, 1, 1001;...
                                             hex2dec('6010'), 2, 1, 1001;...
                                             hex2dec('6010'), 3, 2, 1002;...
                                             hex2dec('6010'), 5, 2, 1002;...
                                             hex2dec('6010'), 7, 1, 1001;...
                                             0              , 0, 1, 0   ;...
                                             0              , 0, 5, 0   ;...
                                             hex2dec('6010'),14, 1, 1001;...
                                             hex2dec('6010'),15, 1, 1001;...
                                             hex2dec('6010'),16, 1, 1001;...
...
if vector
    ...
    rv.input = arrayfun(@(x) struct('pdo', [0 x 0 0]), 0:pdo_count-1);
    ...
    rv.output = arrayfun(@(x) struct('pdo', [1 x 0 0]), 0:pdo_count-1);
