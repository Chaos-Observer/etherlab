    ...
    pdo = {...
            ...
            hex2dec('1a00'),...
               ...
               [ hex2dec('6000'), 1, 1, 1001;
                 ...
                 hex2dec('6000'), 9, 1, 1001;
                 hex2dec('6000'),10, 1, 1001;
                 hex2dec('6000'),11, 1, 1001;
                 0              , 0, 1,    0;
                 hex2dec('6000'),13, 1, 1001;
            ...
            hex2dec('1a01'),...
               ...
               [ hex2dec('6000'), 1, 1, 1001;
                 ...
                 hex2dec('6000'),17,16, 1016;
                 hex2dec('6000'),18,16, 1016],...
               { [0:2,4:7,9], 13, 14 };
            hex2dec('1a02'),...
               hex2dec('1a03'),...
               [ hex2dec('6000'),20,32, 1032],...
               { 0 };
            hex2dec('1a03'),...
               hex2dec('1a02'),...
               [ hex2dec('6000'),19,32, 1032],...
               { 0 };
            hex2dec('1a04'),...
               hex2dec('1a05'),...
               [ hex2dec('6000'),22,64, 1032],...
               { 0 };
            hex2dec('1a05'),...
               hex2dec('1a04'),...
               [ hex2dec('6000'),22,64, 1032],...
