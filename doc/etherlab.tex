...
\item The application core (represented by the Linux kernel module
\lstinline+rt_app_core+), that is responsible for the execution of the realtime
...
\lstinline+rt_app_core+. It maintains internal representations of the loaded
...
The application core (\lstinline+rt_app_core+) must be running before any
