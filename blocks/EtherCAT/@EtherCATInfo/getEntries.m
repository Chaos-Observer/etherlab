function PdoEntryMap = getEntries(varargin)
    % Select:
    %   - Empty:
    ...
    [TxPdoEntryMap TxSm] = getPdoEntryGroups(...
        EtherCATInfo.Descriptions.Devices.Device(1).TxPdo, ...
        EtherCATInfo.Descriptions.Devices.Device(1).Sm, ...
        1, arg.GroupType);
    
    [RxPdoEntryMap RxSm] = getPdoEntryGroups(...
        EtherCATInfo.Descriptions.Devices.Device(1).RxPdo, ...
        EtherCATInfo.Descriptions.Devices.Device(1).Sm, ...
        0, arg.GroupType);
