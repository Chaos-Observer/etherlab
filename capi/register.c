 ...
 * $Id$
 *
 * This file is used to capsulate the C application so that it can
 * be called from the kernel module rt_app.c.
 * 
...
#include <etl_application_description.h>
...
struct rt_app rt_app = {
    ...
    /* Some variables concerning sample times passed to the application */
    .num_st = NUMST,
    .num_tasks = NUMST,
 ...
 *
 * This function is called to perform a calculation step for the application's
 * base period.
 *
 * Return:
 ...
 *
 * Abstract:
 *      Execute application on a generic target such as a workstation.
 */
const char *
app_start(void)
{
